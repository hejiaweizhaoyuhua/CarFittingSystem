...
public class RadiusJButton extends JButton{
	/* 决定圆角的弧度 */
    ...
    public RadiusJButton(){
    	this("", stone1, stone2);
    }
    
    public RadiusJButton(String name){
    	this(name, stone1, stone2);
    }
    
    public RadiusJButton(String name, Color color1, Color color2){
    	super.setText(name);
	...
	private void paintcolor(Color COLOR1, Color COLOR2){
		setMargin(new Insets(5, 00, 5, 00));
