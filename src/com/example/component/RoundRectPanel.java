...
public class RoundRectPanel extends JPanel {
	...
	*/
	...
	public void paintComponent(Graphics g) {
		...
		g2d.fillRoundRect(fieldX, fieldY, fieldWeight, 
				fieldHeight, fieldRoundRect, fieldRoundRect);
		
		if(fieldArc == 1){
			g2d.fillRect(fieldX, fieldY+fieldRoundRect/2, 
					fieldWeight, fieldHeight);
			g2d.fillRect(fieldX+fieldWeight-fieldRoundRect/2, 
					fieldY, fieldRoundRect/2, fieldHeight);
		}else if(fieldArc == 2){
			g2d.fillRect(fieldX, fieldY, fieldWeight-fieldRoundRect/2, 
					fieldHeight);
			g2d.fillRect(fieldWeight-fieldRoundRect/2, 
					fieldHeight-fieldRoundRect/2, fieldRoundRect/2, 
					fieldRoundRect/2);
		}else if(fieldArc == 3){
			g2d.fillRect(fieldX, fieldY, fieldWeight, fieldRoundRect/2);
